...
SYS_INCLUDE += -I "/home/danglamtung/IMU_/codegen/mex/EKF"
SYS_INCLUDE += -I "/home/danglamtung/IMU_"
...
%.$(OBJEXT) : /home/danglamtung/IMU_/%.c
	$(CC) $(CCFLAGS) "$<"

%.$(OBJEXT) : /home/danglamtung/IMU_/codegen/mex/EKF/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : /home/danglamtung/IMU_/%.cpp
	$(CXX) $(CPPFLAGS) "$<"

%.$(OBJEXT) : /home/danglamtung/IMU_/codegen/mex/EKF/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : /home/danglamtung/IMU_/%.cu
	$(CC) $(CCFLAGS) "$<"

%.$(OBJEXT) : /home/danglamtung/IMU_/codegen/mex/EKF/%.cu
	$(CC) $(CCFLAGS) "$<"
